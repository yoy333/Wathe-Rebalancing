...
public abstract class LimitedHandledScreen<T extends ScreenHandler> extends Screen implements ScreenHandlerProvider<T> {
    ...
    public LimitedHandledScreen(T handler, PlayerInventory inventory, Text title) {
        super(title);
